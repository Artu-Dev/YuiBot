...
export const SHOP_ITEMS = {
  ...
  guarda_costas: {
    ...
    rarity: 'incomum',
    price: () => randomInt(150, 500),
    duration: () => 24 * 60 * 60 * 1000,
    effect: 'shield_robbery',
  },
  carta_de_maldicao: {
    name: 'Carta de Maldição',
    description: 'Entregue a alguém — essa pessoa gasta o dobro de chars por 12 a 24h.',
    image: "https://media.tenor.com/SRwentCGRlYAAAAi/balatro-chicot.gif",
    rarity: 'incomum',
    price: () => randomInt(300, 1000),
    duration: () => randomInt(12, 24) * 60 * 60 * 1000,
  ...
  arma_de_prata: {
    name: 'Arma de Prata',
    description: 'Aumenta seu dano em roubos em 35% por 12h.',
  ...
  oraculo: {
    ...
    image: "https://media.tenor.com/olVUagtOP-QAAAAj/futuresquad.gif",
    rarity: 'incomum',
    price: () => randomInt(300, 700),
    duration: () => null,
    effect: 'oraculo',
  ...
  sabotador: {
    ...
    image: "https://c.tenor.com/HyYjefcAVlEAAAAC/tenor.gif",
    rarity: 'raro',
  ...
  amnesia_coletiva: {
    ...
    image: "https://c.tenor.com/vpGEo_akgVsAAAAd/tenor.gif",
    rarity: 'raro',
  ...
  cofre_blindado: {
    ...
    image: "https://c.tenor.com/krvtKjnH6_0AAAAd/tenor.gif",
    rarity: 'raro',
    price: () => randomInt(800, 1800),
    duration: () => 24 * 60 * 60 * 1000,
    effect: 'vault',
  },
  ...
  seguro_desemprego: {
    ...
    image: "https://c.tenor.com/aFcjHKh8x6wAAAAd/tenor.gif",
    rarity: 'incomum',
  ...
  sombra: {
    ...
    image: "https://c.tenor.com/gJ6iOz3HSGwAAAAC/tenor.gif",
    rarity: 'raro',
  ...
  parasita: {
    ...
    image: "https://media.tenor.com/CLQnwaKDBBQAAAAi/white-knuckle-half-life.gif",
    rarity: 'raro',
    price: () => randomInt(700, 1500),
    duration: () => 6 * 60 * 60 * 1000,
    effect: 'parasita',
  ...
  roleta_russa: {
    ...
    image: "https://c.tenor.com/09A-qnjo26MAAAAC/tenor.gif",
    rarity: 'lendário',
    price: () => randomInt(2000, 4000),
    duration: () => null,
    effect: 'roleta_russa',
  ...
  imposto_progressivo: {
    ...
    image: "https://c.tenor.com/j7UdXCy1J4kAAAAC/tenor.gif",
    rarity: 'raro',
  ...
  inflacao: {
    ...
    image: "https://c.tenor.com/wjS2sXen8iMAAAAC/tenor.gif",
    rarity: 'raro',
    price: () => randomInt(1200, 2500),
    duration: () => 24 * 60 * 60 * 1000,
    effect: 'inflacao',
  },
};