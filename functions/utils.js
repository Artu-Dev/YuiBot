...
const emoji = (id, animated = false) => {
  const prefix = animated ? "a" : "";
  return `<${prefix}:emoji:${id}>`;
};

export const customEmojis = {
  loading:            emoji("1492698884621860914", true),
  mineLegendHero:     emoji("1492713986091782287", true),
  infested:           emoji("1492708994249265263", true),
  parrot:             emoji("1492709330091376792", true),
  pepePolice:         emoji("1492714066815484057", true),
  skullGlowing:       emoji("1492713987899527188", true),
  hello:              emoji("1492713993075163186", true),
  rainbowSheep:       emoji("1492709321950367954", true),
  haste:              emoji("1492714122708521104", true),
  pepeVibin:          emoji("1492709377139015893", true),
  pepeMysticCape:     emoji("1492709370352373760", true),
  ...
  skullAndRoses:      emoji("1492705445486399650"),
  poor:               emoji("1492700767554109521"),
  pepeCry:            emoji("1492713990197874698"),
  writingGOOD:        emoji("1492705963503915060"),
  pointingGun:        emoji("1492699969524863167"),
  minecraftDog:       emoji("1492709326123438241"),
  minecraftPaintBust: emoji("1492713985596723200"),
  world:              emoji("1492709310008922262"),
  pepeClown:          emoji("1492709307656044655"),
  pepeThinking:       emoji("1492709372449788034"),
  verifiedCyan:       emoji("1492709327973253350"),
  verifiedGolden:     emoji("1492709303247966409"),
  verifiedPurple:     emoji("1492709297430200370"),
  verifiedGreen:      emoji("1492709290413260933"),
  sadge:              emoji("1492709295391899789"),
  pepePray:           emoji("1492709285782618172"),
  pepeSeenExplosion:  emoji("1492709287347097771"),
  pepeAngry:          emoji("1492709283496853545"),
  pepehmm:            emoji("1492709282087702650"),
  ironIngot:          emoji("1492714001250123938"),
  hearts:             emoji("1492709334562639973"),
  pepeJail:           emoji("1492709337301520567"),
  verifiedBlue:       emoji("1492713999496773734"),
  verifiedWhite:      emoji("1492709218359447622"),
  redstone:           emoji("1492709345538871356"),
  pepepog:            emoji("1492709214814998568"),
  lapislazuli:        emoji("1492709347040690368"),
  enchantedBook:      emoji("1492709349276123317"),
  pepeCruz:           emoji("1492709280644595782"),
  pepeSus:            emoji("1492709359380074617"),
